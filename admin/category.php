...
$save_btn = '<a href="javascript:void(0);" class="btn btn-primary add-category">SAVE</a>';
$temp_input = '';
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter ..." name="category" value="<?php echo $category; ?>">
                    </div>
                  </div>
                  <div class="col-md-12">                
                    <?php echo $temp_input; ?>
