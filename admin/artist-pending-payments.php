...
$page_title = 'Artists Pending Payments';

$list = '';

$or = new Orders();
$orders = $or->artist_pending_payments()['list'];
$total_pages = $or->artist_pending_payments()['total_pages'];
...
foreach ($orders as $order) {
  ...
  <tr>
  	...
  	<td class="text-right">
  	 <a class="btn btn-info btn-xs" href="artist-payments-view?id=$id">
