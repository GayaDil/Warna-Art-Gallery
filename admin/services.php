...
<tr>
	...
	<td class="text-right">
      ...
      <input class="switch-service" data-id="$id" type="checkbox" $checked >
      <span class="switch-indicator"></span>
      <span class="switch-description"></span>
    </label>
    <a class="btn btn-info btn-xs" href="service?id=$id">
...
<!-- ./wrapper -->
    ...
    $(document).ready(function () {
        $('.switch-service').on('change', function () {
            var id = $(this).data('id');
            var this_label = '#status-'+id;
            $.ajax({
                url: 'ajax/ajax-service.php',
                type: 'POST',
                data: 'type=service_status&id=' + id,
