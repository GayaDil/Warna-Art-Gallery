...
$sql = "SELECT * FROM `mediums` ORDER BY `id` DESC";
...
<tr>
	...
	<td class="text-right">
      ...
      <input class="switch-medium" data-id="$id" type="checkbox" $checked >
      <span class="switch-indicator"></span>
      <span class="switch-description"></span>
    </label>
    <a class="btn btn-info btn-xs" href="medium?id=$id">
...
<!-- ./wrapper -->
    ...
    $(document).ready(function () {
        $('.switch-medium').on('change', function () {
            var id = $(this).data('id');
            var this_label = '#status-'+id;
            $.ajax({
                url: 'ajax/ajax-medium.php',
                type: 'POST',
                data: 'type=medium_status&id=' + id,
