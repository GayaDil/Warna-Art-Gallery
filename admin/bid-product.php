...
if ( isset($_GET['id'])) {
    ...
    if($rowCount > 0){
      while($row = $query->fetch_assoc()){
        ...
        $oa = new Users();
        $b_full_name = $oa->user($bidder_id)['full_name'];
...
<tr>
  ...
  <td class="vertical-middle">$b_full_name</</td> 
                ...
                <div class="col-md-6">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                        <td>Artist</td>
                        <td><a href="user-view?id=<?php echo $artist_id; ?>" target="_blank"><b><?php echo $artist_name; ?></b></a></td>
                      </tr>
                      <tr>
                        <td>Time Left</td>
                        <td>
