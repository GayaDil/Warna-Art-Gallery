...
$page_title = 'Order Payments Approve';

$list = '';

$or = new Orders();
$orders = $or->pending_payment_approval()['list'];
$total_pages = $or->pending_payment_approval()['total_pages'];
...
foreach ($orders as $order) {
  ...
  <tr>
  	...
  	<td class="text-right">
  	 <a class="btn btn-info btn-xs" href="order-payments?id=$id">
