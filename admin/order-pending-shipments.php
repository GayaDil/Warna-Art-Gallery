...
$page_title = 'Pending Shipments';

$list = '';

$or = new Orders();
$orders = $or->pending_shipments()['list'];
$total_pages = $or->pending_shipments()['total_pages'];
  ...
  <tr>
    ...
    <td class="text-right">
     <a class="btn btn-info btn-xs" href="order-view?id=$id">
       ...
       <a class="btn btn-info btn-xs" href="paid-orders-view?id=$id">
