...
if (isset($_GET['submit'])) {
    ...
    $s_method = ( $_GET['post_method'] > 0 ) ? $_GET['post_method'] : null;
...
$select_method = ( isset($_GET['post_method']) ) ? $_GET['post_method'] : 0;
...
foreach ( $pm_data as $key => $value ) {
    $pm_selected = ( $key == $select_method ) ? 'selected' : '';
    $pm_list .= '<option value="'.$key.'" '.$pm_selected.'>'.$value.'</option>';
}


$gl = new Homepage();
$galleries = $gl->gallery($s_category, $s_medium, $s_method, $s_query)['list'];
$total_pages = $gl->gallery($s_category, $s_medium, $s_method, $s_query)['total_pages'];
                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <h5 class="my-10">Method</h5>
                                        <select class="form-control" style="width: 100%;" name="post_method">
                                ...
                                <div class="col-md-2 d-flex align-items-end">
                                    <div class="form-group">
                                        ...
                                        <a href="gallery" class="btn btn-outline btn-primary">Clear</a>
                                    </div>
                                </div>
