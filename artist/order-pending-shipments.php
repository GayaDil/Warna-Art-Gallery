...
$or = new Orders();
$orders = $or->pending_shipments($this_user_id, 1)['list'];
$total_pages = $or->pending_shipments($this_user_id, 1)['total_pages'];
...
foreach ($orders as $order) {
  ...
  <tr>
      ...
      <a class="btn btn-info btn-xs" href="order-pending-shipments-view?id=$id">
