...
$temp_input = '<input type="text" name="temp_id" value="'.$this_user_id.'" style="display: none;">';
$img_upload_url = 'modal-profile-image-upload.php';
...
$image_name = $u->user($this_user_id)['image_name'];
$image = $u->user($this_user_id)['image'];
$phone = $u->user($this_user_id)['phone'];
$designation = $u->user($this_user_id)['designation'];
...
$facebook_url = $u->user($this_user_id)['facebook_url'];
$linkedin_url = $u->user($this_user_id)['linkedin_url'];
$instagram_url = $u->user($this_user_id)['instagram_url'];
$new_email = $u->user($this_user_id)['new_email'];

$account_number = $u->user($this_user_id)['account_number'];
$bank_name = $u->user($this_user_id)['bank'];
$branch_name = $u->user($this_user_id)['branch_name'];
$branch_code = $u->user($this_user_id)['branch_code'];
...
$us = new Users();
$us_types = $us->artist_services($this_user_id);
...
$bank_temp_input = '<input type="text" name="temp_id" value="'.$this_user_id.'" style="display: none;">';


$bank_save_btn = '<a href="javascript:void(0);" class="btn btn-primary update-bank">SUBMIT</a>';
				...
				<div class="box-body">
					...
					<div class="tab-content tabcontent-border">
						...
						<div class="tab-pane" id="other" role="tabpanel">
							<form role="form" method="POST" id="form-profile-other-informations">
					   			<div class="box">
						            <div class="box-header with-border">
						              <h4 class="box-title">Other Informations - Education/Exhibition/Awards</h4>
						...
						<div class="tab-pane" id="services" role="tabpanel">
							<form role="form" method="POST" id="form-profile-services">
						    	<div class="box">
						            <div class="box-header with-border">
						...
						<div class="tab-pane" id="privacy" role="tabpanel">
							<form role="form" method="POST" id="form-privacy">
						    	<div class="box">
						            <div class="box-header with-border">
						...
						<div class="tab-pane" id="privacy-email" role="tabpanel">
							<form role="form" method="POST" id="form-privacy-email">
						    	<div class="box">
						            <div class="box-header with-border">
						...
						<div class="tab-pane " id="bank" role="tabpanel">
							<form role="form" method="POST" id="form-bank">
						    	<div class="box">
						            <div class="box-header with-border">
    ...
    $('.thumb_crop').click(function(event){
        ...
        $image_thumb.croppie('result', {
            ...
            $.ajax({
                ...
                type: "POST",
                data: {"type":"upload_profile_picture","image":response},
