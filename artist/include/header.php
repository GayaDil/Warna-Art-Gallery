<header class="main-header">
	...
	<!-- <a href="./../" class="logo"><i class="fa fa-home"></i> HOME</a> -->
	      		...
	      		<li class="dropdown user user-menu">
	        		...
	        		<ul class="dropdown-menu animated flipInY">
			          	...
			          	<li class="user-body">
				            ...
				            <a class="dropdown-item" href="verify"><i class="mdi mdi-verified text-danger"></i> Verify Account</a>
				            <?php endif; ?> 
							<div class="dropdown-divider"></div>
							<div class="p-10">
								<a href="../logout" class="btn btn-sm btn-rounded btn-danger"><i class="ion-log-out"></i> Logout</a>
							</div>
			          	</li>
	        		</ul>
	      		</li>		
